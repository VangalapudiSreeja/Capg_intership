...
public class EmployeeRepository {
	...
	static {
		...
		departments.add(new Department(10,"Administration",166));
		departments.add(new Department(20,"Production",400));
		departments.add(new Department(30,"Sales",123));
		departments.add(new Department(40,"Finance",263));
		departments.add(new Department(50,"Customer Support",200));
		//populate employees 
		employees= new ArrayList<Employee>();
		
		employees.add(new Employee( 100, "Karthik", "Reddy", 
				"KREDDY", "515.123.4567", LocalDate.of(1997,Month.JUNE,17),
				"President", 24000,null, departments.get(0)));
		employees.add(new Employee( 101, "Neelima", "Choudary", 
				"NKOCHHAR", "515.123.4568", LocalDate.of(1999,Month.SEPTEMBER,21),
				"Vice President", 17000,100, departments.get(0)));
		employees.add(new Employee( 102, "Leela", "Devi", 
				"LDEHAAN", "515.123.4569", LocalDate.of(2003,Month.JUNE,13),
				"Vice President", 17000,100, departments.get(0)));
		employees.add(new Employee( 201, "Michael", "Jackson", 
				"MHARTSTE", "515.123.5555", LocalDate.of(1996,Month.FEBRUARY,17),
				"Manager", 13000,100, departments.get(1)));
		employees.add(new Employee( 202, "Shiva", "Krishna", 
				"PFAY", "603.123.6666", LocalDate.of(2007,Month.AUGUST,17),
				"Deputy Manager", 6000,201, departments.get(1)));
		employees.add(new Employee( 124, "Kenny", "Kethan", 
				"KMOURGOS", "650.123.5234", LocalDate.of(2009,Month.NOVEMBER,16),
				"Manager", 5800,100, departments.get(2)));
		employees.add(new Employee( 141, "Tanmayi", "Raju", 
				"TRAJS", "650.121.8009", LocalDate.of(1995,Month.OCTOBER,17),
				"Clerk", 3500,124, departments.get(2)));
		employees.add(new Employee( 205, "Sherley", "Singh", 
		...
		employees.add(new Employee( 199, "Danny", "Harry", 
